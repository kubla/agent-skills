...
This archive was created by the `fulcra-agent-backup` skill. It contains an agent's core identity and memory state (e.g., `SOUL.md`, `IDENTITY.md`, `MEMORY.md`, and the `memory/` directory).
